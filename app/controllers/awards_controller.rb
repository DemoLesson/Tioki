class AwardsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @award.save
        format.html { redirect_to "/me/profile/edit/awards", notice: 'Award was successfully created.' }
      else
  ...
  def update
    ...
    respond_to do |format|
      if @award.update_attributes(params[:award])
        format.html { redirect_to "/me/profile/edit/awards", notice: 'Award was successfully updated.' }
        format.json { head :ok }
      else
